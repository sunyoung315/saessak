    ...
    <div class="flex justify-between items-center">
      ...
      <button v-if="isLogin == true" type="button" data-drawer-target="drawer-right-example"
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none"
          ...
          <path fill-rule="evenodd" clip-rule="evenodd"
            d="M16 0C17.1046 0 18 0.89543 18 2V14C18 15.1046 17.1046 16 16 16H6L0 19V2C0 0.89543 0.89543 0 2 0H16ZM16 2H2V15.468L5.44603 14H16V2ZM8 9V11H4V9H8ZM14 5V7H4V5H14Z"
            fill="#000000" />
        </svg>
      </button>
      ...
      <div id="dropdownNotification"
        ...
        <div v-if="isTeacher == false" class="h-60 overflow-auto">
          <template v-if="alarmList.length">
            <div v-for="alarm in alarmList" :key="alarm.alarmId" @click="removeAlarm(alarm.alarmId)"
      ...
      <button v-if="isLogin == true && isTeacher == true" class="btn m-0 mx-5" type="button" @click="logout()">
        로그아웃
      </button>

      <!-- Dropdown button -->
      <button v-if="isLogin == true && isTeacher == false" id="dropdownDividerButton"
        data-dropdown-toggle="dropdownDivider"
        class="text-black text-lg font-semibold px-5 py-2.5 text-center inline-flex items-center" type="button">
        <img :src="kidList[0].kidProfile" alt="profile"
        ...
        <div id="dropdownDivider"
          ...
          <ul v-for="(kid, idx) in kidList" :key="idx" class="text-sm text-gray-700"
            aria-labelledby="dropdownDividerButton">
            <li v-if="idx > 0">
              <a @click="kidChange(idx)" class="block px-4 py-2 rounded-lg hover:bg-gray-100">{{
                kidList[idx].kidName
              }}</a>
            </li>
          </ul>
          <div class="py-1 bg-gray-200 rounded-b-lg">
            <a @click="newKids()" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-300">아이 등록</a>
