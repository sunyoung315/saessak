	...
	<div class="bg-yellow-50 h-screen w-screen">
        ...
        <UserVideo :stream-manager="mainStreamManagerComputed" />
				...
				<section id="video-container" class="relative">
					<div id="session-title" class="text-xl absolute top-14 left-1/3">
						<span class="font-bold">{{ chatName }}</span
						>의 화상채팅
					</div>
				...
				<div class="">
					<button
						...
						type="button"
						class="absolute bottom-20 left-1/2 right-16 px-4 py-2 mr-2 me-2 mb-1 text-sm font-medium text-gray-900 border-2 border-gray-500 rounded-md focus:outline-none bg-white hover:bg-gray-100 hover:font-bold focus:z-10 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700"
					>
					...
					<button
						...
						@click="handleMuteBtn"
						type="button"
						class="absolute bottom-20 left-16 right-1/2 px-4 py-2 ml-2 me-2 mb-1 text-sm font-medium text-gray-900 border-2 border-gray-500 rounded-md focus:outline-none bg-white hover:bg-gray-100 hover:font-bold focus:z-10 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700"
					>
				...
				<div class="">
					<select
						class="absolute bottom-10 left-16 right-1/2 px-4 py-1 ml-2 me-2 mb-2 border border-gray-500 rounded-md"
						name="audios"
					...
					<select
						class="absolute bottom-10 left-1/2 right-16 px-4 py-1 mr-2 me-2 mb-2 border border-gray-500 rounded-md"
						name="cameras"
