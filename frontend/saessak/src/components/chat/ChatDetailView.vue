...
stomp.connect(
        ...
        frame => {
          ...
          stomp.subscribe("/send/room/" + roomId, res => {
  ...
  console.log("Send message:" + msg.value);
      if (stomp && stomp.connected) {
        const sendMsg = {
          ...
          receiverId : props.roomInfo.receiverId + receiveFlag,
          senderId: props.roomInfo.senderId + sendFlag,
          chatContent: msg.value
        };
        stomp.send("/receive", JSON.stringify(sendMsg), {});
    }
}
