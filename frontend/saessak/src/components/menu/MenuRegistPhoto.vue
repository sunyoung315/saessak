<template>
	<div class="flowbit-modal fixed inset-0 flex items-center justify-center z-50" v-if="isOpen">
		...
		<div class="flowbit-modal__container bg-white w-full max-w-md m-8 md:m-0 rounded-lg shadow-lg z-50 overflow-y-auto">
			<!-- Title & Close Btn -->
			<div class="flowbit-modal__header px-4 flex justify-between items-center">
				...
				<button class="pr-5 pb-3 pl-24 flowbit-modal__close" @click="closeModal">
			...
			<div class="file-upload">
				<!-- 파일 업로드 -->
				<input id="inputFile" ref="inputFile" type="file" @change="readInputFile" />
