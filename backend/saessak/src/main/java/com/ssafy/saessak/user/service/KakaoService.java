...
public class KakaoService {
    ...
    public KakaoResponseDto getKakaoInfo(String code) throws Exception {
    ...
    private KakaoResponseDto getUserInfoWithToken(String accessToken) throws Exception {
        //HttpHeader 생성
        HttpHeaders headers = new HttpHeaders();
        ...
        long id = Long.parseLong(String.valueOf(jsonObj.get("id")));
